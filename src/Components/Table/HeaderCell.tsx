...
export default function HeaderCell(props: HeaderCellProps) {
	...
	return(
		<div onClick={() => toggleSort()} className={clsx("select-none bg-table-header hover:bg-table-header-hover first:rounded-tl-lg last:rounded-tr-lg px-4 border-b border-table-border flex justify-between items-center", props.sortable && props.setSort && "cursor-pointer")}>
