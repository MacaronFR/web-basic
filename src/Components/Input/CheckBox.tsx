...
export default function CheckBox(props: CheckBoxProps) {
	...
	return (
		<label htmlFor={id} className={"block bg-input aspect-square w-5 rounded-md border border-input-border has-disabled:border-input-border-disabled overflow-hidden cursor-pointer select-none has-disabled:cursor-default"}>
